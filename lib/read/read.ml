...
let ttuple (typ: source -> Type.Type.typ parseresult) source: Type.Type.typ parseresult =
...
let tarrow (typ: source -> Type.Type.typ parseresult) source : Type.Type.typ parseresult =
  (map (andThen (andThen (andThen
                            (literal "(")
                            (literal "->"))
                   (n_or_more 2 typ))
